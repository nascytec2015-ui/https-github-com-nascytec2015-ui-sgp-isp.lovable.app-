...
export async function initializeSync() {
  ...
  try {
    ...
    console.log("SERVICE_ROLE_KEY carregada:", !!process.env.SUPABASE_SERVICE_ROLE_KEY);
    console.log("PUBLISHABLE_KEY carregada:", !!process.env.SUPABASE_PUBLISHABLE_KEY);
